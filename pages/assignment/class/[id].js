...
export default function assignment ({nMe, nClassDetail, nStudentList, nQuizList}) {
  return nMe.role=='강사' ? <div style={{ width: "100%" }}><AdminCourseMain nMe={nMe} nClassDetail={nClassDetail} nStudentList={nStudentList} nQuizList={nQuizList} /></div> : <CourseAssignment nMe={nMe} nClassDetail={nClassDetail} nQuizList={nQuizList} />
}
